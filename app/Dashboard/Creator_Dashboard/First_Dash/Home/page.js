    ...
    <div className=" w-[50%] mx-auto mr-80">
        <div className="flex justify-between ">
          ...
          <div className="flex gap-2">
            <button className="flex items-center gap-1 bg-purple-500 border-2 border-purple-500 rounded-lg px-2 py-1 cursor-pointer">
              <img src="/add.svg" alt="" />
              <span> Create </span>
            </button>
            <div className="relative inline-block">
            <button id="dropdownDefaultButton" onClick={() => setShow(!Show)} data-dropdown-toggle="dropdown" className=" cursor-pointer bg-purple-500 border-2 border-purple-500 rounded-lg px-2 py-1" type="button"><img className="w-6 h-6" src="/more_h_w.svg" alt="" />
            </button>
            <div id="dropdown" className={`absolute z-10 ${Show ? "block" : "hidden"} bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-30 dark:bg-slate-700`}>
              <ul className="py-2 text-sm text-slate-400 dark:text-slate-300" aria-labelledby="dropdownDefaultButton">
                <li>
                  <Link href="/Dashboard/Creator_Dashboard/Dashboard2/View_P" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-slate-800 dark:hover:text-white">View Page </Link>
                </li>
                <li>
                  <Link href="/Dashboard/Creator_Dashboard/First_Dash/Edit_P" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-slate-800 dark:hover:text-white">Edit Page</Link>
                </li>
                <li>
                  <Link href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-slate-800 dark:hover:text-white">Page Details</Link>
                </li>
              </ul>
            </div>
            </div>
