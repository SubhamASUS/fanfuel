...
const Navbar2 = () => {
    ...
    if (pathname && pathname.startsWith("/Dashboard/Fan_Dashboard"),("/Dashboard/Creator_Dashboard/First_Dash")) {
        return null;
    }
  ...
  return (
    <nav className="sideNav  w-62 h-[100vh] bg-slate-900 flex flex-col justify-between py-2 px-3 gap-10 border-r-2 border-slate-700">
        <div className="flex flex-col gap-5 ">
          ...
          <Link href={"/Dashboard/Creator_Dashboard/First_Dash/Home"} className={`flex items-center gap-3 text-l font-bold text-white cursor-pointer p-2 hover:bg-slate-800 hover:rounded-2xl ${pathname === "/Dashboard/Creator_Dashboard/First_Dash/Home" ? "bg-slate-800 rounded-2xl" : ""}`}><img className="h-7" src="/Dashboard.svg" alt="" />Dashboard</Link>
          <Link href={"/Dashboard/Creator_Dashboard/Audience"} className={`flex items-center gap-3 text-l font-bold text-white cursor-pointer p-2 hover:bg-slate-800 hover:rounded-2xl ${pathname === "/Dashboard/Creator_Dashboard/Audience" ? "bg-slate-800 rounded-2xl" : "" }`}><img className="h-7" src="/group.svg" alt="" />Audience</Link>
